...
The following command will generate a `.github/workflows/buf-migrate.yml` file in your project:

```bash
fluentci gh init -t buf_pipeline
```

Or, if you already have a `.fluentci` folder (generated from `fluentci init -t buf`) in your project:
